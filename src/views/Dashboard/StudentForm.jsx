...
<div class="max-w-2xl mx-auto mt-10">
    ...
    <div class="mb-4 w-full bg-gray-50 rounded-lg border border-gray-200 dark:bg-gray-700 dark:border-gray-600">
        ...
        <div class="py-2 px-4 bg-white rounded-b-lg dark:bg-gray-800">
            ...
            <textarea  onChange={changeEmails}id="editor" rows="8" class="block px-0 w-full text-2xl text-gray-800 bg-white border-0 dark:bg-gray-800 focus:ring-0 dark:text-white dark:placeholder-gray-400" placeholder="Add new emails..." required name="emails"></textarea>
        </div>
    </div>
