...
<div className="bg-blue-300 h-screen overflow-hidden flex items-center justify-center" >
  <div className="bg-white lg:w-5/12 md:6/12 w-10/12 shadow-3xl">
    ...
    className="p-12 md:p-24"> 
      ...
      {errors.mail && <p className="text-red-700" role="alert">{errors.mail?.message}</p>}
      ...
      <div className="flex items-center text-lg mb-6 md:mb-8">
       ...
       {errors.mail && <p className="text-red-700" role="alert">{errors.password?.message}</p>}
...
=======
  ...
  return (
    <>
      <Navbar />
      <div className="bg-blue-300 h-screen overflow-hidden flex items-center justify-center" style={{ height: 570 }}>
        <div className="bg-white lg:w-5/12 md:6/12 w-10/12 shadow-3xl">
          <div className="bg-gray-800 absolute left-1/2 transform -translate-x-1/2 -translate-y-1/2 rounded-full p-4 md:p-8">
            <svg
              width="32"
          ...
          <form onSubmit={handleSubmit(async (data) => {
            ...
            <div className="flex items-center text-lg mb-6 md:mb-8">
              ...
              <input
                type="password"
                id="password"
                className="bg-gray-200 pl-12 py-2 md:py-4 focus:outline-none w-full text-xl"
                placeholder="Password"
                {...register("password", { required: "Password is required" })}
              />
            </div>
            {errors.email && <p className="text-red-700" role="alert">{errors.password?.message}</p>}
